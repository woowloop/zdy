...
public class NISkeletonControllerInspector : Editor
{
    ...
    override public void OnInspectorGUI()
    {
		...
		controller.ReferencedManElbow = EditorGUILayout.ObjectField("ReferencedManElbow", controller.ReferencedManElbow, typeof(Transform), true) as Transform;
		controller.ReferencedManFoot = EditorGUILayout.ObjectField("ReferencedManFoot", controller.ReferencedManFoot, typeof(Transform), true) as Transform;
		controller.ReferencedManHand = EditorGUILayout.ObjectField("ReferencedManHand", controller.ReferencedManHand, typeof(Transform), true) as Transform;
		controller.ReferencedManHead = EditorGUILayout.ObjectField("ReferencedManHead", controller.ReferencedManHead, typeof(Transform), true) as Transform;
		controller.ReferencedManKnee = EditorGUILayout.ObjectField("ReferencedManKnee", controller.ReferencedManKnee, typeof(Transform), true) as Transform;
		controller.ReferencedManShoulder = EditorGUILayout.ObjectField ("ReferencedManShoulder", controller.ReferencedManShoulder, typeof(Transform), true) as Transform;
        EditorGUILayout.Space();
